...
|---|---|---|
| `expo` | SDK 51+ (latest stable at project init) | Always check `npx expo install` for SDK-compatible versions — Expo pins RN/library versions per SDK release; don't hand-pick mismatched versions. |
